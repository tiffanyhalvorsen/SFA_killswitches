---
title: "Induction matrices: co-induction experiment to test antitoxin protection and toxin potency from Ptac and Pcym promoters"
output: pdf_document
---
...
TH88 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211026_TH88_matrix.csv")
TH88_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211026_TH88_matrix_KEYS_&firstRead_2.csv",
  well_ids_column = "Key")
...
TH99 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211028_TH99_matrix.csv")
TH99_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211028_TH99_matrix_KEYS_&firstRead_2.csv",
  well_ids_column = "Key")
...
TH128 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211027_TH128_matrix.csv")
TH128_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211027_TH128_matrix_KEYS_&firstRead_2.csv",
  well_ids_column = "Key")
...
TH128b <- read.csv(
  "~/SFA_killswitches/data/matrices/20220114_TH128repeat_matrix.csv")
TH128_keysb <- read_plate(
  "~/SFA_killswitches/data/matrices/20220114_TH128repeat_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH126 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211103_TH126_matrix.csv")
TH126_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211103_TH126_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH100 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211104_TH100_matrix.csv")
TH100_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211104_TH100_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH131 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211109_TH131_matrix.csv")
TH131_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211109_TH131_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH99b <- read.csv(
  "~/SFA_killswitches/data/matrices/20211110_TH99repeat_matrix.csv")
TH99b_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211110_TH99repeat_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH100b <- read.csv(
  "~/SFA_killswitches/data/matrices/20211115_TH100repeat_matrix.csv")
TH100b_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211115_TH100repeat_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH177 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220105_TH177_matrix.csv")
TH177_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220105_TH177_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH177b <- read.csv(
  "~/SFA_killswitches/data/matrices/20220107_TH177repeat_matrix.csv")
TH177b_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220107_TH177repeat_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH179 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220111_TH179_matrix.csv")
TH179_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220111_TH179_matrix_KEYS_&firstRead.csv",
  well_ids_column = "Key")
...
TH131_noIPTG <- read.csv(
  "~/SFA_killswitches/data/matrices/20220119_TH131repeat(woIPTG)_matrix.csv")
TH131_noIPTG_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220119_TH131repeat(woIPTG)_matrix_KEYS_&firstread.csv",
  well_ids_column = "Key")
...
TH100_noIPTG <- read.csv(
  "~/SFA_killswitches/data/matrices/20220126_TH100repeat(woIPTG)_matrix.csv")
TH100_noIPTG_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220126_TH100repeat(woIPTG)_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
Also test co-induction of Tse2 and ColE2 circuits containing altered immunity proteins. 

```{r echo=FALSE}

TH240 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220302_TH240_matrix.csv")
TH240_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220302_TH240_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
TH237 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220303_TH237_matrix.csv")
TH237_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220303_TH237_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
TH245 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220311_TH245repeat_matrix.csv")
TH245_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220311_TH245repeat_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
TH249 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220317_TH249_matrix.csv")
TH249_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220317_TH249_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
TH253 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220324_TH253_matrix.csv")
TH253_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220324_TH253_matrix_KEYS&firstread.csv",
  well_ids_column = "Key")
...
Calculate relative growth of altered immunity strains (rel to no toxin induction at each level of immunity induction).
...
Plot altered immunity relative growth in grid format.
...
```
```{r echo=FALSE}
ggsave(filename = "20220323_matrices_alteredimmunities_Paper.png", path = "~/SFA_killswitches/results/figures", width = 9, height = 3.5, units = "in", device='png', dpi=300)
```
...
```
```{r echo=FALSE}
ggsave(filename = "20220324_matrix&Curves_TH245_2Replicates.png", path = "~/SFA_killswitches/results/figures", width = 7, height = 6.5, units = "in", device='png', dpi=300)
```
...
# TH105 <- read.csv(
#   "~/SFA_killswitches/data/matrices/20201020_TH146_titration_nM_range.csv")
...
# TH124 <- read.csv(
#   "~/SFA_killswitches/data/matrices/20210920_Synergy_ToxinScreen2_Plate1.csv")
# TH124_keys <- read.csv(
#   "~/SFA_killswitches/data/matrices/20210920_keys_forEcoRIonly.csv")
# 
...
TH124 <- read.csv(
  "~/SFA_killswitches/data/matrices/20211206_EcoRI_titration.csv")
TH124_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20211206_EcoRI_titration_KEYS.csv",
  well_ids_column = "Key")
...
TH203_TH204 <- read.csv(
  "~/SFA_killswitches/data/matrices/20220203_TH86_TH203_TH204_titration.csv")
TH203_TH204_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220203_TH86_TH203_TH204_titration_KEYS_&firstread.csv",
  well_ids_column = "Key")
...
single_toxins <- read.csv(
  "~/SFA_killswitches/data/matrices/20220121_single_toxins_SBW25.csv")
single_toxins_keys <- read_plate(
  "~/SFA_killswitches/data/matrices/20220121_single_toxins_SBW25_KEYS.csv",
  well_ids_column = "Key")
...
```{r echo=FALSE}
ggsave(filename = "20220126_TisB_matrix_forPaper.png", path = "~/SFA_killswitches/results/figures", width = 4, height = 1.3, units = "in", device='png', dpi=300)
```
...
```{r echo=FALSE}
ggsave(filename = "20220122_all_matrices_IPTGanalysis.png", path = "~/SFA_killswitches/results/figures", width = 3.7, height = 3.8, units = "in", device='png', dpi=300)
```
...
# TH88_t0 <- pivot_longer(TH88_t0, cols = A01:H12, names_to = "Key", values_to = "OD600")
# 
# TH88_t0 <- pivot_wider(TH88_t0, names_from = "Keys", values_from = "OD600")
# TH88_3 <- TH88
# y <- hms(TH88_3$Time)
...
# 
# TH88_growth_all <- "/Users/halvorsen1/SFA_killswitches/results/figures/TH88_growth_all.txt"
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH88_matrix_undinduced_gcFit.png",
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH99_matrix_undinduced_gcFit.png",
#     width = 520, height = 480, units = "px")
# plot(TH99_1)
# dev.off()
# 
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH100_matrix_undinduced_gcFit.png",
#     width = 520, height = 480, units = "px")
# plot(TH100_1)
# dev.off()
# 
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH131_matrix_undinduced_gcFit.png",
#     width = 520, height = 480, units = "px")
# plot(TH131_1)
# dev.off()
# 
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH126_matrix_undinduced_gcFit.png",
#     width = 520, height = 480, units = "px")
# plot(TH126_1)
# dev.off()
# 
...
# 
# png(filename = "/Users/halvorsen1/SFA_killswitches/results/figures/TH128_matrix_undinduced_gcFit.png",
#     width = 520, height = 480, units = "px")
# plot(TH128_1)
# dev.off()
# 
...
# 
# growth_rates <- data.frame(Strain, rate, `gen_time`)
...
# write.table(growth_rates, file = "/Users/halvorsen1/SFA_killswitches/results/figures/killswitch_growthRates.txt")
# 
# growth_table <- growth_rates %>%
#   kbl(caption = "Kill switch strains: growth rate and generation times") %>%
#   kable_classic(full_width = F, html_font = "Arial") %>%
#   save_kable(file = "/Users/halvorsen1/SFA_killswitches/results/figures/growth_rates.png", self_contained = T, zoom = 4) 
...
```{r echo=FALSE}
ggsave(filename = "20220714_ColTsematrices.png", path = "~/SFA_killswitches/results/figures", width = 9, height = 3.5, units = "in", device='png', dpi=300)
```
...
```{r echo=FALSE}
ggsave(filename = "20211123_matrix&Curves_TH126_noIPTG_2Replicates.png", path = "~/SFA_killswitches/results/figures", width = 6, height = 6.5, units = "in", device='png', dpi=300)
```
